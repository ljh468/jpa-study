...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = -756113173L;
    ...
    public final jpabook.jpashop.domain.Delivery.QDelivery delivery;
    ...
    public QOrder(Class<? extends Order> type, PathMetadata metadata, PathInits inits) {
        ...
        this.delivery = inits.isInitialized("delivery") ? new jpabook.jpashop.domain.Delivery.QDelivery(forProperty("delivery"), inits.get("delivery")) : null;
